...
### AIM:
To Create a project on Time series analysis on Stock market data using ARIMA model in  Python and compare with other models.
### ALGORITHM:
...
```
<img width="1117" height="321" alt="image" src="https://github.com/user-attachments/assets/506b786a-3377-41e5-bcae-3d711cc21f65" />
```
============================================================
...
```
<img width="1111" height="630" alt="image" src="https://github.com/user-attachments/assets/574a549a-998c-492c-ae53-9387db19dad0" />
```
ADF Test — 1st Order Differenced Close Price
  ADF Statistic : -6.0084
  p-value       : 0.0000
  Critical Values: 1%: -3.4537, 5%: -2.8718, 10%: -2.5722
  → STATIONARY (p < 0.05)
```
<img width="1127" height="957" alt="image" src="https://github.com/user-attachments/assets/ae338f02-509c-402e-927c-024c919299a6" />
```
============================================================
...
```
<img width="1120" height="478" alt="image" src="https://github.com/user-attachments/assets/f236f460-d135-4350-a601-62fdd333e4af" />
```
============================================================
...
2025-12-01               954.49
```
<img width="1118" height="794" alt="image" src="https://github.com/user-attachments/assets/9b8f2905-d73e-47f3-8bf6-32cc16de14ba" />
